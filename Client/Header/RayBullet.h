...
class CRayBullet : public CPlayerAttackUnion
{
	DERIVED_CLASS(CPlayerAttackUnion, CRayBullet)

private:
	explicit CRayBullet(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CRayBullet(const CRayBullet& rhs);
	virtual ~CRayBullet();
...
public:
	...
	static CRayBullet* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos, _vec3 vDir,
