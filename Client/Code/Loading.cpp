...
_uint CLoading::Loading_For_Stage()
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_MonsterTextureComp", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"./Resource/Texture/Monster/IdleReady_0.png")), E_FAIL);
