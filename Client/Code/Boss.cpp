...
CBoss* CBoss::Create(LPDIRECT3DDEVICE9 pGraphicDev, const FSerialize_GameObject tObjectSerial)
{
    ThisClass* pInstance = new ThisClass(pGraphicDev);
...
HRESULT CBoss::Ready_GameObject(const FSerialize_GameObject tObjectSerial)
{
