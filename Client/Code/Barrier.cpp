...
//CBarrier* CBarrier::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float _x, _float _y, _float _z, MonsterPhase _CurrPhase, CGameObject* pOwner)
CBarrier* CBarrier::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float _x, _float _y, _float _z)
{
...
HRESULT CBarrier::Ready_GameObject()
{
	...
	// 이미지 
	m_pTextureComp->Receive_Texture(TEX_NORMAL, L"Effect", L"Barrier");
	...
	// 크기조정
	m_pTransformComp->Set_Scale({ 3.f, 3.f, 1.f });
...
void CBarrier::LateUpdate_GameObject()
{
...
void CBarrier::OnCollision(CGameObject* pDst)
{
}

void CBarrier::OnCollisionEntered(CGameObject* pDst)
{
}

void CBarrier::OnCollisionExited(CGameObject* pDst)
{
}
