...
HRESULT CStage::Ready_Layer_GameLogic(const _tchar * pLayerTag)
{
	...
	FAILED_CHECK_RETURN(pLayer->Add_GameObject(L"Brown2", CBrown::Create(m_pGraphicDev, 20.f, 1.f, 50.f)), E_FAIL);
	FAILED_CHECK_RETURN(pLayer->Add_GameObject(L"Brown", CBrown::Create(m_pGraphicDev, 20.f, 1.f, 25.f)), E_FAIL);
