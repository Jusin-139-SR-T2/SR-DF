...
CCubeTexComponent::CCubeTexComponent()
{
}

CCubeTexComponent::CCubeTexComponent(LPDIRECT3DDEVICE9 pGraphicDev)
	: Base(pGraphicDev)
{
}

CCubeTexComponent::CCubeTexComponent(const CCubeTexComponent& rhs)
	: Base(rhs)
{
}
...
CCubeTexComponent* CCubeTexComponent::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	...
	if (FAILED(pInstance->Ready_Buffer()))
	{
		...
		MSG_BOX("CCubeTexComponent Create Failed");
		return nullptr;
	}
...
CComponent* CCubeTexComponent::Clone(void)
{
	return new ThisClass(*this);
}

void CCubeTexComponent::Free(void)
{
	SUPER::Free();
}


HRESULT CCubeTexComponent::Ready_Buffer(void)
{
	m_dwFVF = FVF_CUBE;
	m_dwVtxCnt = 8;
	m_dwTriCnt = 12;
