...
CTerrainTexComponent::CTerrainTexComponent(LPDIRECT3DDEVICE9 pGraphicDev)
	: Base(pGraphicDev)
	, m_dwCountX(0U), m_dwCountZ(0U)
	, m_bHeightMap_Loaded(false)
	, m_pPos(nullptr)
...
CTerrainTexComponent::CTerrainTexComponent(const CTerrainTexComponent& rhs)
	: Base(rhs)
...
CTerrainTexComponent* CTerrainTexComponent::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pFileName, const _ulong& dwCntX, const _ulong& dwCntZ, const _ulong& dwVtxItv)
{
...
CComponent* CTerrainTexComponent::Clone()
{
	// 복사 생성
...
HRESULT CTerrainTexComponent::Ready_Buffer(const _tchar* pFileName, const _ulong& dwCntX, const _ulong& dwCntZ, const _ulong& dwVtxItv)
{
...
void CTerrainTexComponent::Render_Buffer()
{
	SUPER::Render_Buffer();
}

HRESULT CTerrainTexComponent::Load_HeightMap(const _tchar* pFileName)
{
