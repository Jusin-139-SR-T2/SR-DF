...
#pragma region Brown Monster - 작업대기상태 
	...
	//FAILED_CHECK_RETURN(Engine::Ready_Texture(L"../Client/Resource/Texture/Monster/Brown/BasiCPlayerLighter/BasiCPlayerLighter_%d.png", TEX_NORMAL, L"Brown_Multi", L"BasiCPlayerLighter", _range<_uint>(0U, 4U)), E_FAIL);
	...
	//FAILED_CHECK_RETURN(Engine::Ready_Texture(L"../Client/Resource/Texture/Monster/Brown/WalkNorth/WalkNorth_%d.png", TEX_NORMAL, L"Brown_Multi", L"Walk_North", _range<_uint>(0U, 31U)), E_FAIL);
...
#pragma endregion
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_PlayerTextureComp", CTextureComponent::Create(m_pGraphicDev, TEX_NORMAL, L"Player", L"Steel_Pipe")), E_FAIL);	// 텍스처

	//FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_BrownTextureComp", CTextureComponent::Create(m_pGraphicDev, TEX_NORMAL, L"Brown_Single", L"Stand_South")), E_FAIL);	// Brown몬스터 
